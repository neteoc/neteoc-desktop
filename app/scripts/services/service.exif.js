    ...
    function exif() {
        ...
        this.objectURLToBlob = function(url, callback) {
        ...
        this.findIPTCinJPEG = function(file) {
            var dataView = new DataView(file);
        ...
        this.readIPTCData = function(file, startOffset, sectionLength) {
            var dataView = new DataView(file);
            var data = {};
        ...
        this.convertToDegree = function(arrayDMS) {
